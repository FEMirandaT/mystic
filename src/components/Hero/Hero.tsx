      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-2">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-screen">
          <div className="space-y-3 md:space-y-5">
            ...
            <div className="bg-fuchsia-700/90 backdrop-blur-sm rounded-2xl p-4 md:p-6 border border-gray-800/70 hover:border-rose-600/50 transition-colors duration-300 w-full">
            ...
            {/* <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="flex items-center space-x-3 bg-fuchsia-700/80 backdrop-blur-sm rounded-xl p-4 border border-gray-800/50 hover:border-purple-600/50 transition-colors duration-300">
              ...
              <div className="flex items-center space-x-3 bg-fuchsia-700/80 backdrop-blur-sm rounded-xl p-4 border border-gray-800/50 hover:border-teal-600/50 transition-colors duration-300">
                <div className="w-10 h-10 rounded-lg flex items-center justify-center flex-shrink-0">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-2">
              ...
              <button
                className="border-2 border-fuchsia-600 text-fuchsia-600 hover:text-gray-900 hover:border-fuchsia-900 px-6 md:px-8 py-3 md:py-4 rounded-xl font-semibold text-base md:text-lg hover:bg-gray-100/80 transition-all duration-300 backdrop-blur-sm"
                onClick={() => {
            ...
            <div className="grid grid-cols-3 gap-4 md:gap-6 pt-6 md:pt-8">
              <div className="text-center bg-fuchsia-700/90 backdrop-blur-sm rounded-xl p-3 md:p-4 border border-gray-800/50 hover:border-emerald-600/50 transition-colors duration-300">
              ...
              <div className="text-center bg-fuchsia-700/90 backdrop-blur-sm rounded-xl p-3 md:p-4 border border-gray-800/50 hover:border-teal-600/50 transition-colors duration-300">
                <div className="text-2xl md:text-3xl font-bold text-white">
                  24/7
                </div>
                <div className="text-white text-xs md:text-sm">Soporte</div>
              </div>
              <div className="text-center bg-fuchsia-700/90 backdrop-blur-sm rounded-xl p-3 md:p-4 border border-gray-800/50 hover:border-purple-600/50 transition-colors duration-300">
                <div className="text-2xl md:text-3xl font-bold text-white">
                  100%
                </div>
